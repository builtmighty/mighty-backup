...
return array(
    ...
    'BM_Backup_Dev_Mode' => $baseDir . '/includes/class-dev-mode.php',
    'BM_Backup_File_Archiver' => $baseDir . '/includes/class-file-archiver.php',
    'BM_Backup_Log_Stream' => $baseDir . '/includes/class-log-stream.php',
    'BM_Backup_Logger' => $baseDir . '/includes/class-logger.php',
    'BM_Backup_Manager' => $baseDir . '/includes/class-backup-manager.php',
    'BM_Backup_Retention_Manager' => $baseDir . '/includes/class-retention-manager.php',
    'BM_Backup_Scheduler' => $baseDir . '/includes/class-scheduler.php',
    'BM_Backup_Settings' => $baseDir . '/includes/class-settings.php',
    'BM_Backup_Spaces_Client' => $baseDir . '/includes/class-spaces-client.php',
    'BM_Devcontainer_Manager' => $baseDir . '/includes/class-devcontainer-manager.php',
