...
return array(
    ...
    'Mighty_Backup_Api_Endpoint' => $baseDir . '/includes/class-api-endpoint.php',
    'Mighty_Backup_Api_Key_CLI_Command' => $baseDir . '/includes/class-cli-command.php',
    'Mighty_Backup_CLI_Command' => $baseDir . '/includes/class-cli-command.php',
    'Mighty_Backup_Database_Exporter' => $baseDir . '/includes/class-database-exporter.php',
    'Mighty_Backup_Dev_Mode' => $baseDir . '/includes/class-dev-mode.php',
    'Mighty_Backup_Devcontainer_CLI_Command' => $baseDir . '/includes/class-cli-command.php',
    'Mighty_Backup_Error_Translator' => $baseDir . '/includes/class-error-translator.php',
    'Mighty_Backup_File_Archiver' => $baseDir . '/includes/class-file-archiver.php',
    'Mighty_Backup_Log_Stream' => $baseDir . '/includes/class-log-stream.php',
    'Mighty_Backup_Logger' => $baseDir . '/includes/class-logger.php',
    'Mighty_Backup_Manager' => $baseDir . '/includes/class-backup-manager.php',
    'Mighty_Backup_Placeholder_Repair' => $baseDir . '/includes/class-placeholder-repair.php',
    'Mighty_Backup_Repair_CLI_Command' => $baseDir . '/includes/class-repair-cli-command.php',
    'Mighty_Backup_Retention_Manager' => $baseDir . '/includes/class-retention-manager.php',
    'Mighty_Backup_Scheduler' => $baseDir . '/includes/class-scheduler.php',
    'Mighty_Backup_Settings' => $baseDir . '/includes/class-settings.php',
    'Mighty_Backup_Settings_CLI_Command' => $baseDir . '/includes/class-cli-command.php',
    'Mighty_Backup_Spaces_Client' => $baseDir . '/includes/class-spaces-client.php',
    'Mighty_Devcontainer_Manager' => $baseDir . '/includes/class-devcontainer-manager.php',
